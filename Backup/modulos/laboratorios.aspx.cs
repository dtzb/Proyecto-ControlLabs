    ...
    public partial class laboratorios : System.Web.UI.Page
    {
        ...
        private string listaLaboratorios()
        {
            ...
            foreach (DataRow laboratorio in lista.Rows)
            {
                ...
                resultado += "<button class=\"asignar\" onmouseup = \"Proceso.asignaLab('" + laboratorio["Numero"] + "');\" disabled=\"true\">Asignar</button>";
                resultado += "<button class=\"liberar\" onmouseup = \"Proceso.liberaLab('" + laboratorio["Numero"] + "');\" disabled=\"false\">Liberar</button>";
                resultado += "</li>";
            }
            resultado += "</ul>";
            return resultado;
